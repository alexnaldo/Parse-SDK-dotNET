...
namespace Parse.Internal.Utilities
{
    ...
    internal static class StorageManager
    {
        ...
        public static string PersistentStorageFilePath => Path.GetFullPath(Path.Combine(ParseClient.CurrentConfiguration.StorageConfiguration.RelativeStorageFilePath, ParseClient.CurrentConfiguration.StorageConfiguration?.RelativeStorageFilePath ?? FallbackPersistentStorageFilePath));
        ...
        {
            path = Path.GetFullPath(Path.Combine(ParseClient.CurrentConfiguration.StorageConfiguration.RelativeStorageFilePath, path));
